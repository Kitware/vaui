...
import { NEW_ACTIVITY, CREATE_ACTIVITY_END } from '../actions/types';
            ...
            <div className='panel panel-default'>
                ...
                <div className='panel-body'>
                    <form className='form-horizontal'>
                        <div className='row'>
                            <label className='col-sm-12'>Activity</label>
                        </div>
                        ...
                        <div className='row'>
                            <label className='col-sm-12'>Tracks</label>
                        </div>
                        <div className='row'>
